...
-- // Panels {{{
	...
	-- Lobby {{{
		...
		function jcms.offgame_BuildPersonalTab(tab)
			...
			-- Stats {{{
				...
				function stats:Rebuild()
					...
					for i, factionName in ipairs(jcms.factions_GetOrder()) do
						...
						killTableHeight = killTableHeight + 50
			...
			-- Achievements {{{
			-- NOTE: This is some of the shittest code you've ever seen. Touch at your own risk.
				...
				function achievs:Rebuild()
					...
					local achievsTable = inner:Add("DPanel")
					achievsTable:SetSize(inner:GetWide() - 48, 40)
					achievsTable.Paint = jcms.offgame_paint_Table
					achievsTable.tableRows = {}
					achievsTable.tableColumns = 2
					achievsTable.tableColumnsOffset = 0.1
					...
					local achievsTableHeight = 10
					local achievsSectionHeight = 90
					local achievementOrder = jcms.achievements_GetOrder()
					...
					for i, achievementName in ipairs(achievementOrder) do 
						--print("doing achievement " .. i)
						local completed = Color(70, 70, 70)
						...
						table.insert(achievsTable.tableRows, {
							color = completed,
							title = "#jcms.achievement_" .. achievementName,
							[1] = "#jcms.achievement_" .. achievementName .. "_desc",
							[2] = "Progress: " .. achievementStat .. "/" .. achievementAmount,
							indent = 3
						})
					end
				achievsTable:SetTall(#achievsTable.tableRows * 42)
				--print("Achievements should be building with " .. #achievsTable.tableRows .. " rows.")
			end
